...
class LineChart(MatplotlibViz):
    ...
    def visualization(self, asset_id, model, *args, **kwargs):
        ...
        ax.set_title("Employee Events Over Time", fontsize=20)
...
def home():
    ...
    # NB: The above does not work - it crashes because QueryBase is an abstract class
    # and does not contain the necessary methods to be used in the report
    # Instead, we will use the Employee class and just point it to Employee #1 as the default
